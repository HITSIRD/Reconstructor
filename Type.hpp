...
namespace sfs {
    ...
    enum DirectionType {
        FRONT = 0b00000001, BACK = 0b00000010, LEFT = 0b00000100, RIGHT = 0b00001000, TOP = 0b00010000,
        BOTTOM = 0b00100000
    };

    enum DirectionMask {
        MASK_FRONT = 0b00111110, MASK_BACK = 0b00111101, MASK_LEFT = 0b00111011, MASK_RIGHT = 0b00110111,
        MASK_TOP = 0b00101111, MASK_BOTTOM = 0b00011111, BOUND = 0b00111111
    };
}
